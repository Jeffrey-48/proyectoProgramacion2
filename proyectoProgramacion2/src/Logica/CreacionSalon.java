...
public class CreacionSalon {
	...
	public void crearSalones() {
		...
		Salon s3 = new Salon("Salon200", "Facultad de ciencias basicas piso2",200 , null, null, null,null);
		Salon s4 = new Salon("Salon300", "Facultad de educacion piso3", 300, null, null, null,null);
		Salon s5 = new Salon("Salon400", "Facultad de ciencias humnas piso4", 400, null, null, null,null);
